  ...
  return `
    ...
    <div class="page">
      ...
      <div class="srcgrid">
        ...
        <div class="srccard"><b>시도교육청 계약공개</b><span>학교 수의계약 내역 — 소액 구매까지 포함 (16개 시도교육청 · 전북은 아직 수집 전)</span></div>
        <div class="srccard"><b>나이스 교육정보 개방 포털</b><span>교육부 — 전국 학교 명단·소재지 · 등재 12,666개교 중 123개교(재외한국학교·외국인/국제학교·공동실습소·학교급 미기재)를 빼고 12,543개교를 싣습니다</span></div>
        <div class="srccard"><b>학교 위치(지도)</b><span>한국교육시설안전원 초중등학교 위치(2026.3 기준) 및 OpenStreetMap·주소 검색, OpenFreeMap 지도 활용</span></div>
        <div class="srccard"><b>언론 보도·공식 자료</b><span>학교 홈페이지, 교육청 발표, 보도자료 — 44건(0.01%)</span></div>
      </div>
      ...
      <ul>
        ...
        <li><b>“외 3종”처럼 묶어 적은 계약</b>은 함께 산 제품을 알 수 없습니다. 전체 계약의 <b>약 11%</b>가 이런 형태이고, 그 안에 <b>1만 종이 넘는 제품명</b>이 확인되지 못하고 있습니다.</li>
      ...
      <h3>자료는 어떻게 갱신되나</h3>
      <p><b>매월 10일 새벽 3시에 자동으로 갱신됩니다.</b></p>

      <h3>전남광주 통합과 서비스 대응</h3>
      <p>2026년 7월 1일 광주광역시와 전라남도가 「전남광주통합특별시」로 통합되면서 교육청도 같은 날
      ...
      <ul>
        ...
        <li>학교 명단은 교육부 NEIS 개방 포털 기준입니다. 초·중·고 12,078개교에 더해
          ...
          <b>공동실습소 9곳</b>은 학교가 아니어서, <b>학교급이 비어 있는 2개교</b>는 분류할 수 없어 제외하였습니다.</li>
      </ul>
