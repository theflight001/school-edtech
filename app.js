...
(function loadDetail() {
  ...
  s.src = "/data_detail.js?b=20260922b";
...
function withOld(from, then) {
  ...
  const add = () => {
    ...
    s2.src = "/data_detail_old.js?b=20260922b";
    s2.onload = () => {
...
function sggLoad() {
  ...
  return SGG_P = fetch("/sgg_2018_topo.json?b=20260922b").then(r => r.json()).then(t => {
